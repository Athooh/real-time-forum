...
import { setupInfiniteScroll, formatTimeAgo } from "../../utils.js";
// main functions
...
function setupPostEventListeners() {
  ...
  document
    .querySelectorAll(".action-like-btn, .action-dislike-btn")
    .forEach((btn) => {
  ...
  document
    .querySelectorAll("#title-input-text, #thought-input-text")
    .forEach((input) => {
...
function renderPosts(posts, append = false, singlePost = false) {
  ...
  posts.forEach((post) => {
    registerTimeElement(`post-time-${post.id}`, post.timestamp, formatTimeAgo);
  });
